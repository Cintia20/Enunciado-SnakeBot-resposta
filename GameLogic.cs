...
public class GameLogic : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Create SmartBot
        GameObject smartSnake = Instantiate(snakePrefab, new Vector3(0, 0, 0), Quaternion.identity);
        smartSnake.name = "SmartBot";
        snakes.Add(smartSnake);
        SmartBot smartBehavior = ScriptableObject.CreateInstance<SmartBot>();
        smartSnake.GetComponentInChildren<SnakeMovement>().SetBehaviour(smartBehavior);
